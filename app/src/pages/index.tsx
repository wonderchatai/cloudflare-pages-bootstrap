...
`;
  ...
  return (
    <div style={{ fontFamily: "'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Fira Sans', 'Droid Sans', 'Helvetica Neue', sans-serif", lineHeight: '1.6', padding: '2rem', maxWidth: '800px', margin: '0 auto', background: '#f9f9f9', borderRadius: '10px', boxShadow: '0 5px 25px rgba(0,0,0,0.1)' }}>
      <Head>
